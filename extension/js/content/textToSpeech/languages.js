...
let langs = [
    ...
    new SotLanguage("my", "Burmese (Myanmar)"),
    ...
    new SotLanguage("jv", "Javanese (Indonesia)"),
    new SotLanguage("kn", "Kannada"),
    ...
    new SotLanguage("ml", "Malayalam"),
    new SotLanguage("mr", "Marathi"),
